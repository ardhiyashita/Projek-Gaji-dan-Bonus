...
int absen()
{
	...
	int pilihan_bulan;
	int jml, bln, data, jumlah_hari, alpha, total, tahun;
	char pilihan4;
	int banyak;
	char konfirmasi;
...
system("cls"); 
	...
	scanf("%d", &data3[i].bulan);

	if(data3[i].bulan==1||data3[i].bulan==3||data3[i].bulan==5||data3[i].bulan==7||data3[i].bulan==8||data3[i].bulan==10||data3[i].bulan==12)
	{
		jumlah_hari=31;
		printf("MASUKKAN KETIDAKHADIRAN	: ");
		scanf("%d", &data3[i].alpha); 
		data3[i].total=jumlah_hari-data3[i].alpha;
	}
	else if(data3[i].bulan==4 ||data3[i].bulan==6 ||data3[i].bulan==9 ||data3[i].bulan==11)
	{
		jumlah_hari=30;
		printf("MASUKKAN KETIDAKHADIRAN	: ");
		scanf("%d", &data3[i].alpha); 
...
printf("\n\n	====== REKAP ABSENSI ====== \n"); 
printf("============================================================\n"); 
printf("| NO |	NAMA | PERIODE BULAN | TOTAL KEHADIRAN |\n"); 
printf("============================================================\n");
for (i = 0; i < jml; i++){
	printf("  %d	%-12s	%-8d	%-7d\n", i+1, data3[i].namaP, data3[i].bulan, data3[i].total);
}
printf("============================================================\n");
//-------------------------------------------------------------------------------------------------------------------------------------------------------
printf("\nIngin melanjutkan ke menu berikutnya? (y/n) --> ");
